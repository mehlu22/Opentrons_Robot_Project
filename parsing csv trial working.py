...
print(dataset.loc[0, 'reagent_name'])
print(dataset.loc[0, 'slot'])
print(dataset.loc[0, 'position'])
print(dataset.loc[1, 'reagent_name'])
print(dataset.loc[1, 'slot'])
print(dataset.loc[1, 'position'])