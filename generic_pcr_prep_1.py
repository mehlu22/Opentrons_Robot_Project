def get_values(*names):
    import json
    _all_values = json.loads("""{"right_pipette_lname":"p20_single_gen2","left_pipette_lname":"p1000_single_gen2","use_filter_tips_left":false,"use_filter_tips_right":false,"labware_1_lname":"opentrons_24_tuberack_nest_0.5ml_screwcap","labware_2_lname":"opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap","twelve_well_resv_lname":"nest_12_reservoir_15ml","master_mix_csv":"Reagent,Slot,Well,Volume\\nBuffer,1,A2,25\\nMgCl,1,A3,40\\ndNTPs,1,B2,90\\nWater,1,B3,248\\nprimer 1,1,A4,25\\nprimer 2,1,A5,25\\n"}""")
