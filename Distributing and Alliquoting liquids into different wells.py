...
#j = "ABCDEFGHI"
# Protocol steps
#pipette.pick_up_tip(tiprack_1['A2'])
#pipette.well_bottom_clearance.aspirate = '15'
pipette.distribute(25 , plate.wells_by_name()['B4'], reservoir2.rows_by_name()['A'], carryover = 'True')
#pipette.dispense(100, reservoir['A{0}'.format(i)], rate = 0.5)
#pipette.blow_out(reservoir['A'])
#pipette.return_tip()
